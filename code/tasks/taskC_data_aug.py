...
val_acc_history, best_cfm \
  = train_model("taskC_data_aug", device, model_ft, dataloaders_dict, criterion, optimizer_ft, num_epochs=num_epochs, is_inception=False)
