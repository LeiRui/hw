...
val_acc_history, best_cfm \
  = train_model("taskC_dropout", device, model_ft, dataloaders_dict, criterion, optimizer_ft, num_epochs=num_epochs, is_inception=False)

import time
import os
now = time.strftime("%Y-%m-%d-%H_%M",time.localtime(time.time()))
dir = "/workspace/ruilei/hw/result/taskC_dropout_"+now
